...
def _(elements):
    ...
    return check_elements, prussian_blue
...
def _():
    ...
    return uranium_left, uranium_sample
...
def _():
    def sort_masses(mass_list):
        ...
        for i in range(1,n):
            for j in range(n-i):
                if mass_list[j]>mass_list[j+1]:
                    mass_list[j], mass_list[j+1] = mass_list[j+1], mass_list[j]
